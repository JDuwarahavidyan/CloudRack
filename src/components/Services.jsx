...
const Services = () => {
  ...
  const services = [
    ...
    },
    {
      ...
      title: "SAP Workload Hosting & Migration",
      description: "Run mission-critical SAP workloads on certified cloud infrastructure with end-to-end migration support. From S/4HANA transitions to managed SAP BASIS operations, we ensure performance, compliance, and high availability.",
      tags: ["SAP HANA", "S/4HANA", "SAP BASIS", "Certified Cloud"]
    },
    {
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      ...
      description: "Transform raw data into actionable insights with scalable data lakes, real-time streaming pipelines, and interactive dashboards. Enable data-driven decisions across your organization.",
      tags: ["Data Lake", "ETL", "Power BI", "Real-Time"]
    },
    {
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
